...
public class SKActivityIndicator: NSObject {
    ...
    fileprivate var backgroundViewColor    : UIColor                = UIColor.init(red  : 0.0, green  : 0.0, blue  : 0.0, alpha  : 1.0)
    ...
    private override init() {
        ...
        let transperantView = UIView.init(frame: (window?.frame)!)
        transperantView.backgroundColor = UIColor.black.withAlphaComponent(0.5)
        window?.insertSubview(transperantView, at: 0)
    }
